    ...
    <div id="profile">
      <div id="opt">  
         <nav>
          ...
          <div class="navigate" >
 <p v-for="item in navigator" :key="item" @click="navigate(item.name)">
     {{item.name}}  
 </p>
...
<div class="user-pic">
  ...
  <!-- <span><i class="fas fa-user"></i></span> -->
   ...
   <div class="elipsis" @click="reacts"><i class="fas fa-ellipsis-h"></i></div>

<div id="reaction-popup" v-if="reacted">
    <ul >
<li>Save Video</li>
<li>Copy Link</li>
<li>Hide Post</li>
<li>snooze person for 30days</li>
<li @click="deletePost(post.id)">Delete this Post</li>
    </ul>
</div>
...
import { getFirestore, collection, addDoc, doc, getDocs, getDoc, onSnapshot, query, where, setDoc, updateDoc, deleteDoc} from "firebase/firestore"
...
deleteDoc(doc(db, "created-post", id))
console.log("deleted")
        },
reacts(){
